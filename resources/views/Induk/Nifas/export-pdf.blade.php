...
<html lang="en">
  ...
  <body>
    <h1 class="text-center">Data Ibu Nifas Posyandu Se-Desa Renggeang</h1>
    <table class="table table-striped">
        <thead>
          <tr>
            ...
            <th class="text-center" scope="col">TANGGAL MELAHIRKAN</th>
            <th class="text-center" scope="col">STATUS MENYUSUI</th>
          </tr>
        </thead>
        <tbody>
        @foreach ($pospartum as $key => $item)
        <tr>
